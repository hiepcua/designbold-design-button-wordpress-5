...
class DesignBold
{
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      DesignBold_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	 ...
	 *
	 * - DesignBold_Loader. Orchestrates the hooks of the plugin.
	 * - DesignBold_i18n. Defines internationalization functionality.
	 * - DesignBold_Admin. Defines all hooks for the admin area.
	 *
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-designbold-loader.php';
	 ...
	 *
	 * Uses the DesignBold_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	 ...
	 *
	 * @since     1.0.0
	 * @return    DesignBold_Loader    Orchestrates the hooks of the plugin.
	 */
